...
class ut_``BASE_CMP_T extends BASE_CMP_T; \
    ...
    virtual protected function void policy_compliance(uvm_sequence_item act, \
...
`ut_cmp_class(evm_in_order_lossless_comparer)
`ut_cmp_class(evm_out_of_order_lossless_comparer)
