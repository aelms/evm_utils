 ...
 */
class evm_out_of_order_lossless_comparer extends evm_series_comparer;
    
    `uvm_object_utils(evm_out_of_order_lossless_comparer);

    extern function new( string name = "evm_out_of_order_lossless_comparer");
...
endclass: evm_out_of_order_lossless_comparer

function evm_out_of_order_lossless_comparer::new( string name = "evm_out_of_order_lossless_comparer" );
    super.new(name);
    set_fast_item_compare_mode(TRUE);
endfunction: new

function void evm_out_of_order_lossless_comparer::apply_policy(item_type_e rx_si_type); 
...
function void evm_out_of_order_lossless_comparer::policy_compliance(uvm_sequence_item act, 
                                                                    uvm_sequence_item exp, 
                                                                    item_type_e       rx_si_type);
...
function void evm_out_of_order_lossless_comparer::check_phase();
...
function void evm_out_of_order_lossless_comparer::reset_phase();
