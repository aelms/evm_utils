 ...
 */
class evm_in_order_lossless_comparer extends evm_series_comparer;
    
    `uvm_object_utils(evm_in_order_lossless_comparer);

    extern function new( string name = "evm_in_order_lossless_comparer");
...
endclass: evm_in_order_lossless_comparer

function evm_in_order_lossless_comparer::new( string name = "evm_in_order_lossless_comparer" );
    super.new(name);
endfunction: new

function void evm_in_order_lossless_comparer::apply_policy(item_type_e rx_si_type); 
...
function void evm_in_order_lossless_comparer::policy_violation(uvm_sequence_item act, 
                                                               uvm_sequence_item exp, 
                                                               item_type_e       rx_si_type);
...
function void evm_in_order_lossless_comparer::policy_compliance(uvm_sequence_item act, 
                                                                uvm_sequence_item exp, 
                                                                item_type_e       rx_si_type);
...
function void evm_in_order_lossless_comparer::check_phase();
...
function void evm_in_order_lossless_comparer::reset_phase();
