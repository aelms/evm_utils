 ...
 */
class evm_ral_field_edge_event extends uvm_reg_cbs;

    `uvm_object_utils(evm_ral_field_edge_event)
    ...
    function new(string name = "evm_ral_field_edge_event");
        super.new(name);
    endfunction: new
...
endclass: evm_ral_field_edge_event
