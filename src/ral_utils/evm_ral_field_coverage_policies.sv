 ...
 * 
 */
virtual class evm_ral_field_coverage_policy extends uvm_void;
    ...
    `uvm_type_name_decl("evm_ral_field_coverage_policy")
...
endclass: evm_ral_field_coverage_policy
 ...
 */
class evm_ral_field_all_bits_set_clr_policy extends evm_ral_field_coverage_policy;

    `uvm_type_name_decl("evm_ral_field_all_bits_set_clr_policy")
...
endclass: evm_ral_field_all_bits_set_clr_policy
 ...
 * begin.   
 */
class evm_ral_field_min_mid_max_policy extends evm_ral_field_coverage_policy;

    `uvm_type_name_decl("evm_ral_field_min_mid_max_policy")
...
endclass: evm_ral_field_min_mid_max_policy
 ...
 */
class evm_ral_field_all_values_policy extends evm_ral_field_coverage_policy;

    `uvm_type_name_decl("evm_ral_field_all_values_policy")
...
endclass: evm_ral_field_all_values_policy

/** \brief RAL field five ranges policy
 * 
 *  This RAL field coverage policy 
 */
class evm_ral_field_five_ranges_policy#(int unsigned MIN_LEGAL, int unsigned MAX_LEGAL) extends evm_ral_field_coverage_policy;
...
endclass: evm_ral_field_five_ranges_policy
